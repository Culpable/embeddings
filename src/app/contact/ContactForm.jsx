...
function RadioInput({ label, ...props }) {
  return (
    <label className="flex gap-x-3 rounded-2xl border border-transparent p-2 transition hover:bg-neutral-950/[0.03] has-[:checked]:border-neutral-950/10 has-[:checked]:bg-neutral-950/[0.04] has-[:disabled]:cursor-not-allowed has-[:disabled]:opacity-60">
      <input
        type="radio"
        {...props}
